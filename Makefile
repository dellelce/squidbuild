...
ACLOCAL = ${SHELL} /home/antonio/src/web/squid/repo/cfgaux/missing aclocal-1.14
ADAPTATION_LIBS = 
ALLOCA = 
AMTAR = $${TAR-tar}
...
AUTOCONF = ${SHELL} /home/antonio/src/web/squid/repo/cfgaux/missing autoconf
AUTOHEADER = ${SHELL} /home/antonio/src/web/squid/repo/cfgaux/missing autoheader
AUTOMAKE = ${SHELL} /home/antonio/src/web/squid/repo/cfgaux/missing automake-1.14
AWK = gawk
BASIC_AUTH_HELPERS =  DB LDAP MSNT-multi-domain NCSA NIS POP3 RADIUS SASL SMB SSPI fake getpwnam
BZR = 
...
EXEEXT = .exe
EXPATLIB = 
EXTERNAL_ACL_HELPERS =  LDAP_group LM_group SQL_session eDirectory_userip file_userip kerberos_ldap_group session time_quota unix_group wbinfo_group
EXT_LIBECAP_CFLAGS = 
EXT_LIBECAP_LIBS = 
FALSE = /usr/bin/false
FGREP = /usr/bin/fgrep
...
MAINT = #
MAKEINFO = ${SHELL} /home/antonio/src/web/squid/repo/cfgaux/missing makeinfo
MANIFEST_TOOL = :
MINGW_LIBS = 
MKDIR = /usr/bin/mkdir
MKDIR_P = /usr/bin/mkdir -p
MV = /usr/bin/mv
NEGOTIATE_AUTH_HELPERS =  SSPI kerberos wrapper
NETTLELIB =  -lnettle
NM = /usr/bin/nm -B
NMEDIT = 
...
install_sh = ${SHELL} /home/antonio/src/web/squid/repo/cfgaux/install-sh
